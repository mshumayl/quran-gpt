      ...
      <main className="flex flex-col min-h-screen min-w-fit items-center bg-slate-100">
        ...
        {/* Get Started Button */}
          <div className="flex flex-col items-center pt-10 w-full md:w-2/3 lg:w-1/3">
            ...
            text-center text-md md:text-lg font-zilla-slab-italic
          ...
          <div className="pt-10">
            {/* Features list */}
            <div className="grid grid-rows-4 md:grid-rows-none md:grid-cols-2 mx-12 xl:mx-44 h-fit md:h-fit gap-4 md:gap-6">
              <div className="flex flex-col items-center text-center m-2 mx-6 xl:mx-20 h-30 p-2">
                ...
                <div className="font-zilla-slab-italic text-emerald-500 text-md md:text-lg uppercase">Advanced AI-powered search</div>
                <div className="font-zilla-slab-italic text-md text-slate-600 ">
              ...
              <div className="flex flex-col items-center text-center m-2 mx-6 xl:mx-20 h-30 p-2">
                ...
                <div className="font-zilla-slab-italic text-emerald-500 text-md md:text-lg uppercase">A personal database of verses</div>
                <div className="font-zilla-slab-italic text-md text-slate-600">
                  Save favourite verses to your bookmarks to start building your own library of <a className="text-emerald-500 bg-slate-200 rounded-md px-1">Quranic verse cards</a> at your disposal. 
                </div>
              </div>
              <div className="flex flex-col items-center text-center m-2 mx-6 xl:mx-20 h-30 p-2">
                ...
                <div className="font-zilla-slab-italic text-emerald-500 text-md md:text-lg uppercase">Your digital brain for Quranic daleel</div>
                <div className="font-zilla-slab-italic text-md text-slate-600">
              ...
              <div className="flex flex-col items-center text-center m-2 mx-6 xl:mx-20 h-30 p-2">
                ...
                <div className="font-zilla-slab-italic text-emerald-500 text-md md:text-lg uppercase">AI summarization of verse translations</div>
                <div className="font-zilla-slab-italic text-md text-slate-600">
                  Create summaries on your verse cards and add them to your notes collection with the help of the <a className="text-emerald-500 bg-slate-200 rounded-md px-1">AI model</a>.
                </div>
              </div>
              </div>
