...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-row pt-10 items-start justify-center bg-gradient-to-b from-gray-50 to-gray-200">
        <div className="flex flex-col items-center justify-center gap-2 px-4 py-16 ">
          ...
          <div className="pt-10">
            ...
            <div className="flex flex-col items-center pt-10">
              <Link className="bg-slate-300 items-center mx-6 my-5 px-4 py-3 border-black rounded-full border-2 border-dashed hover:bg-slate-400 transition-all duration-75" href="/">Get started</Link>
            </div>
          </div>
