        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="flex flex-col bg-[url('/graph-paper.svg')] bg-slate-50 drop-shadow-lg pb-20 pt-14 border-t-2 border-b-2 border-emerald-500 w-full justify-center items-center">
            <div className="flex flex-col">
              <div className="flex w-max -mr-3 bg-emerald-300 shadow-emerald-200 shadow-lg mb-2 px-2 py-1 md:px-3 md:py-2 md:text-lg rounded-full text-xs font-jost text-white place-self-end">BETA</div>
