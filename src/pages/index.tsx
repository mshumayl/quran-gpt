    ...
    <>
      ...
      <main className="flex flex-col min-h-screen min-w-fit items-center bg-slate-100">
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="flex flex-col bg-[url('/graph-paper.svg')] bg-slate-100 pb-20 pt-14 border-t-2 border-b-2 border-emerald-500 w-full justify-center items-center">
